...
const defaultPermissions = [
  ...
  { name: 'reports.view', display_name: 'ເບິ່ງລາຍງານທຸລະກິດ', module: 'Reports', description: 'ເບິ່ງລາຍງານ ລາຍຮັບ, ລາຍຈ່າຍ ແລະ ກຳໄລ' },
  { name: 'reports.products', display_name: 'ເບິ່ງລາຍງານສິນຄ້າຂາຍດີ', module: 'Reports', description: 'ເບິ່ງອັນດັບສິນຄ້າທີ່ຂາຍດີທີ່ສຸດ' },
  { name: 'reports.expenses', display_name: 'ເບິ່ງລາຍງານລາຍຈ່າຍ', module: 'Reports', description: 'ເບິ່ງລາຍລະອຽດລາຍຈ່າຍ ແລະ ຕົ້ນທຶນ' },
  { name: 'reports.staff', display_name: 'ເບິ່ງລາຍງານຜົນງານພະນັກງານ', module: 'Reports', description: 'ເບິ່ງຍອດຂາຍຂອງພະນັກງານແຕ່ລະຄົນ' },
  // Refunds
...
const roleDefaults = {
  ...
  manager: [
    ...
    'sales.view', 'sales.create', 'sales.report', 'reports.view',
    'reports.products', 'reports.expenses', 'reports.staff',
